...
type MapSubscribeRequest struct {
	...
	Receiver            MapSubscribeRequestReceiver `json:"Receiver,omitempty"`
	Sender              MapSubscribeRequestSender   `json:"Sender,omitempty"`
...
type MapSubscribeRequestReceiver struct {
...
type MapSubscribeRequestSender struct {
...
type MapSubscribeRequestAddService struct {
